...
class ApiTradingClientControllerDemo extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (@$_GET['limit']) {
            $tradings = UserTradingDemo::where('user_id', $user->id)->where('status', 'Closed')->orderby('id', 'desc')->paginate($_GET['limit']);
            return response()->json([
                'items' => $tradings,
                'message' => 'Success',
            ],
            ...
            $tradings = UserTradingDemo::where('user_id', $user->id)->where('status', 'Closed')->orderby('id', 'desc')->paginate(10);
            return response()->json([
                'items' => $tradings,
                'message' => 'Success',
            ],
    ...
    public function indexOpen(Request $request)
    {
        ...
        if (@$_GET['limit']) {
            $tradings = UserTradingDemo::where('user_id', $user->id)->where('status', 'open')->orderby('id', 'desc')->paginate($_GET['limit']);
            return response()->json([
                'items' => $tradings,
                'message' => 'Success',
            ],
            ...
            $tradings = UserTradingDemo::where('user_id', $user->id)->where('status', 'open')->orderby('id', 'desc')->paginate(10);
            return response()->json([
                'items' => $tradings,
                'message' => 'Success',
            ],
    ...
    public function getBalance(Request $request)
    {
        ...
        return response()->json(['message' => 'Success', 'value' => WalletTradingBalanceDemo($user->id)], 200);
    }
    public function postReset(Request $request)
    {
        ...
        \DB::table('wallet_trading_demos')->where('user_id', $user->id)->delete();
        $walletTradingDemo = new WalletTradingDemo();
        $walletTradingDemo->user_id = $user->id;
