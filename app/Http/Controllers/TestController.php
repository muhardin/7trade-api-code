...
class TestController extends Controller
{
    ...
    public function index()
    {
        ...
        curl_setopt($ch, CURLOPT_URL, 'https://api.7trade.pro/callback/alphapays');
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($ch, CURLOPT_POST, 1);
        curl_setopt($ch, CURLOPT_POSTFIELDS, "{\n\t\"transaction\": {\n        \"currency\": \"BTC\",\n        \"address\": \"mxdg1nsJWzX8hcUoGECRymnuyEGLdZJrUE\",\n        \"hash\": \"66a8cc563fcd6fe9efba1368028757c14c80f3279237c6efead2b7747c0d0090\",\n        \"amount\": \"0.00123456\",\n        \"ts\": 1619547269,\n        \"status\": \"processing\",\n        \"success\": true,\n        \"processorTransactionId\": \"234567890\",\n        \"fiatAmount\": \"2345\",\n        \"fiatCurrency\": \"USD\",\n        \"userID\": \"1234\",\n        \"userName\": \"1234\",\n        \"confirmNo\": \"0\",\n        \"merchantTransactionId\": \"234567890\",\n    }\n}");

        $headers = array();
        $headers[] = 'Content-Type: application/json';
        $headers[] = 'X-Merchant-Identifier: 123';
        $headers[] = 'X-Signature: b13c929d8928dafc9ce9468c0bc81b7cd362825d8ca402b1934b58bc7a27fd70';
        ...
        $apiKey = '1011415';
        $apiSecret = '6a0cf7c6d69049139d562fbd45792619';
