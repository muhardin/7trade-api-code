...
<head>
    ...
    <!--[if !mso]><!-->
    <style type="text/css">
        <blade media|%20only%20screen%20and%20(max-width%3A480px)%20%7B%0D>@-ms-viewport {
            width: 320px;
        }

        <blade viewport|%20%7B%0D>width: 320px;
        }
        }
    </style>
    <!--<![endif]-->
    ...
    <style type="text/css">
        <blade media|%20only%20screen%20and%20(min-width%3A480px)%20%7B%0D>.mj-column-per-100 {
            width: 100% !important;
        }
        }
    </style>
