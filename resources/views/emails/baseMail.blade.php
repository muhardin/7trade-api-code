...
<head>
    ...
    <!--[if !mso]><!-->
    <style type="text/css">
        <blade media|%20only%20screen%20and%20(max-width%3A480px)%20%7B>@-ms-viewport {
            width: 320px;
        }

        <blade viewport|%20%7B>width: 320px;
        }
        }
    </style>
    <!--<![endif]-->
    ...
    <style type="text/css">
        <blade media|%20only%20screen%20and%20(min-width%3A480px)%20%7B>.mj-column-per-100 {
            width: 100% !important;
        }
        }
    </style>
                        ...
                        <td
                            ...
                            <div class="mj-column-per-100 outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td><div style="padding-left: 24px">{!! @$messages !!}</div></td>
                                    </tr>
